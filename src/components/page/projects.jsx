              ...
              <>
                ...
                <div className="col mb-3">
                  <div className="card-container g-3">
                    ...
                    <p className="project-subtitule px-2">Diseñé y desarrollé la web responsive de Bijao Restaurant con WordPress y Elementor. Creé la identidad visual, contenidos y marca, optimizando la experiencia para sus dos ubicaciones: Kissimmee y Davenport</p>
                  </div>
                </div>
              </>
            )}
