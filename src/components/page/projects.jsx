    ...
    <div>
      <div className="bg-body-tertiary">
        ...
        <p className="fs-5 text-body-secondary">
          Realizados con tecnologías modernas y mejores prácticas de desarrollo web
        </p>
        ...
        <ul className="nav nav-tabs justify-content-center mb-4">
          <li className="nav-item">
            <button 
              className={`nav-link ${activeTab === "profesionales" ? "active" : ""}`}
                    ...
                    <div className="card shadow-sm">
                      ...
                      <div className='card_hover'>
                        <NavLink to="https://shoe-kingdom-ae164.web.app/index.html">
                          <button className='boton1'><i className="fa fa-external-link" aria-hidden="true"></i></button>
                        </NavLink>
                      </div>
                    </div>
                    <h3 className='project-titule py-2'>E-ecommerce</h3>
                    <p className='project-subtitule'>React, Bootstrap, Redux, Express, Postgresql</p>
                  </div>
                </div>
                  ...
                  <div className="card-container g-3">
                    <div className="card shadow-sm">
                      <NavLink to="https://impresion3-d.vercel.app/">
                        <img src={imagen5} className="img-fluid border project-image" alt="Project 5" />
                      </NavLink>
                      <div className='card_hover'>
                        <NavLink to="https://impresion3-d.vercel.app/">
                          <button className='boton1'><i className="fa fa-external-link" aria-hidden="true"></i></button>
                  ...
                  <div className="card-container g-3">
                    <div className="card shadow-sm">
                      <NavLink to="https://anatmb.github.io/Escueladecostura/">
                        <img src={imagen2} className="img-fluid border project-image" alt="Project 2" />
                      </NavLink>
                      <div className='card_hover'>
                        <NavLink to="https://anatmb.github.io/Escueladecostura/">
                          <button className='boton1'><i className="fa fa-external-link" aria-hidden="true"></i></button>
                  ...
                  <div className="card-container g-3">
                    <div className="card shadow-sm">
                      <NavLink to="https://frontendfinal-d212e.web.app/">
                        <img src={imagen3} className="img-fluid border project-image" alt="Project 3" />
                      </NavLink>
                      <div className='card_hover'>
                        <NavLink to="https://frontendfinal-d212e.web.app/">
                          <button className='boton1'><i className="fa fa-external-link" aria-hidden="true"></i></button>
                    ...
                    <h3 className='project-titule py-2'>Proyecto académico (Portafolio)</h3>
                  ...
                  <div className="card-container g-3">
                    <div className="card shadow-sm">
                      <NavLink to="https://pi-dogs-main-rose.vercel.app/">
                        <img src={imagen4} className="img-fluid border project-image" alt="Project 4" />
                      </NavLink>
                      <div className='card_hover'>
                        <NavLink to="https://pi-dogs-main-rose.vercel.app/">
                          <button className='boton1'><i className="fa fa-external-link" aria-hidden="true"></i></button>
                    ...
                    <h3 className='project-titule py-2'>App con API TheDogApi</h3>
                    <p className='project-subtitule'>React, Redux, Sequelize, PostgreSQL</p>
                  </div>
                </div>
              </>
            )}
      ...
      <section className='contact-home'>
        <div className="row">
          <div className="col-12">
            ...
            <p>Estaré encantada de ayudarte a digitalizar con éxito tu negocio</p>
